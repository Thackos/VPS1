...
while True:
    try:
        ...
        print("SWEAT STUSSY " + str(DELAI) + " secondes...")
        time.sleep(DELAI)
        envoie_discord(URL_SWEAT_STUSSY, WEBHOOK_URL_SWEAT_STUSSY)
        print("JeanJacques2 dans " + str(DELAI) + " secondes...")
        time.sleep(DELAI)
        envoie_discord(URL_JEANJACQUES_2, WEBHOOK_URL_JEANJACQUES_2)
    except Exception:
        pass
